...
{if empty($error)}
    <ol id="toc">
        <li>
            <a href="#general"><span>{lang 'Info'}</span></a>
        </li>
        <li>
            <a href="#map"><span>{lang 'Map'}</span></a>
        </li>
        {if $is_relatedprofile_enabled}
            <li>
                <a href="#related_profile"><span>{lang 'Similar Profiles'}</span></a>
            </li>
        {/if}

        {if $is_friend_enabled}
            <li>
                <a href="#friend"><span>{friend_link}</span></a>
            </li>
            {if $is_logged AND !$is_own_profile}
                <li>
                    <a href="#mutual_friend"><span>{mutual_friend_link}</span></a>
                </li>
            {/if}
        {/if}
        ...
        {if $is_forum_enabled}
            <li>
              <a href="#forum"><span>{lang 'Topics'}</span></a>
            </li>
        {/if}
        {if $is_note_enabled}
            <li>
    ...
    <div class="content" id="general">
        ...
        {if !empty($join_date)}
            <p>
                <span class="bold">{lang 'Join Date:'}</span> <span class="italic">{join_date}</span>
            </p>
            <div class="break"></div>
        {/if}
        ...
        {if !empty($last_activity)}
            <p>
                <span class="bold">{lang 'Last Activity:'}</span> <span class="italic">{last_activity}</span>
            </p>
            <div class="break"></div>
        {/if}

<div class="center">
    <p>{lang}<strong><a href="http://ph7cms.com">pH7CMS</a></strong> is built by a small volunteer team of engineers, programmers, designers, and others in many different sites across the globe. It is updated continuously, and<br />
    ...
    or help us in the translation of one of our open source CMS, you can directly start by <a href="https://github.com/pH7Software/pH7-Social-Dating-CMS">forking our project on Github</a> or contact us via our <a href="http://ph7cms.com/contact/">contact form</a>.<br />
    Moreover, this unique experience will <strong>make the difference more than ever on your CV</strong>.{/lang}</p>

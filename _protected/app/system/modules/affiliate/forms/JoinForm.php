...
class JoinForm
{
    public static function step1()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Date(t('Your Date of birth:'), 'birth_date', ['id' => 'birth_date', 'description' => t('Please specify your birth date using the calendar.'), 'onblur' => 'CValid(this.value, this.id)', 'required' => 1, 'validation' => new \PFBC\Validation\BirthDate]));

...
class AddUserForm
{
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Date(t('Date of birth:'), 'birth_date', ['title' => t('Please specify the birth date using the calendar.'), 'validation' => new \PFBC\Validation\BirthDate, 'required' => 1]));
